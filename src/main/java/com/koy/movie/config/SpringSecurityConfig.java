...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/","/member/**","/movie/**").permitAll()
                .antMatchers(HttpMethod.GET, "/member/signup").permitAll()/*회원가입 페이지는 무조건 허용*/
                .antMatchers(HttpMethod.GET, "/member/login").permitAll()/*로그인 페이지 허용.*/
                .antMatchers(HttpMethod.POST, "/member/api/signup").permitAll()/*회원가입 요청은 무조건 허용*/
                .antMatchers(HttpMethod.POST, "/member/api/login").permitAll()/*로그인 요청 허용*/
